...
func (p *Plugin) checkSudoResult(result *core.Result, flags map[string]interface{}) error {
	if result.Success {
		return nil
	}
...
func (p *Plugin) handleUpgrade(ctx context.Context, conn core.Connection, args []string, flags map[string]interface{}) error {
...
func (p *Plugin) handleFullUpgrade(ctx context.Context, conn core.Connection, args []string, flags map[string]interface{}) error {
...
func (p *Plugin) handleAutoremove(ctx context.Context, conn core.Connection, args []string, flags map[string]interface{}) error {
...
func (p *Plugin) handleShell(ctx context.Context, conn core.Connection, args []string, flags map[string]interface{}) error {
...
func (p *Plugin) handleUninstall(ctx context.Context, conn core.Connection, args []string, flags map[string]interface{}) error {
	if len(args) < 1 {
